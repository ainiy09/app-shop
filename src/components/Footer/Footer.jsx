...
import telegram from '../Footer/img/telegram.svg'
				...
				<div className="footer__wrapper">
					...
					<div className="footer__col">
						<div className="contacts">
							...
							<a className="contacts__tel contacts__link" href="tel:89999999999">
								8 (999) 999-99-99
							</a>
							<a className="contacts__mail contacts__link" href="dogfood.ru@gmail.com">
